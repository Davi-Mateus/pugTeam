...
public class JanelaAlteracaoHorario {
	...
	public void initialize(JanelaPrincipal instanciaJanelaPrincipal) {
		...
		frame.setTitle("Alterar horários de aula");
		...
		lblHoraInicio = new JLabel("Nova hora início aula:");
		...
		btnSalvar.addActionListener(new ActionListener() {			
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!alteracao) {
					JOptionPane.showMessageDialog(null, "ERRO ao alterar o horário de aula no banco de dados");
					limpaCampos();
					return;
				}
				...
				JOptionPane.showMessageDialog(null, "Horário de aula alterado com sucesso");
			}
		});
